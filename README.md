...
```bash
sigma-sam-project$ sam local start-api
sigma-sam-project$ curl http://localhost:3000/
```
...
```bash
sigma-sam-project$ sam logs -n HelloWorldFunction --stack-name sigma-sam-project --tail
```
...
```bash
sigma-sam-project$ cd hello-world
